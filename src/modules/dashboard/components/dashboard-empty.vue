...
const handleConnectToZoho = () => {
  ...
  const SCOPES =
    "ZohoInvoice.invoices.READ,ZohoInvoice.invoices.UPDATE,ZohoInvoice.settings.READ,ZohoBooks.settings.READ,ZohoBooks.invoices.UPDATE,ZohoBooks.invoices.READ";
