...
const metaTitle = "A2 Marketplace";
...
const metaCompanyName = "a2 marketplace";
const metaCompanyCreator = "Efemena Elvis";
const metaCompanyBaseUrl = "https://www.a2comply.com";
...
const getMetaTitle = computed(
  () => `${getTitleText.value} A2 Marketplace` || metaTitle
);
